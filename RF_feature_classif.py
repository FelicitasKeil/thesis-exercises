...
plt.scatter(np.log10(bll["PL_Flux_Density"]),np.log10(bll["Variability_Index"]), #Scatter PL_Ind vs. Variab
            label='BL Lacs', color='green',edgecolors='none', 
            alpha=0.5, marker='.') 
plt.scatter(np.log10(fsrq["PL_Flux_Density"]),np.log10(fsrq["Variability_Index"]), label='FSRQs',    
            color='red',edgecolors='none', alpha=0.5, marker='.') 
plt.scatter(np.log10(bcu["PL_Flux_Density"]),np.log10(bcu["Variability_Index"]), label='BCUs',  
...
plt.scatter(np.log10(bll["Pivot_Energy"]),np.log10(bll["Signif_Avg"]), #Pivot_E vs. Signif
            label='BL Lacs', color='green',edgecolors='none', 
            alpha=0.5, marker='.') 
...
plt.scatter(np.log10(bll["Flux1000"]),bll["PL_Index"],          #int flux vs. latitude
            label='BL Lacs', color='green',edgecolors='none', 
            alpha=0.5, marker='.') 
plt.scatter(np.log10(fsrq["Flux1000"]),fsrq["PL_Index"],        #int flux vs. latitude
            label='FSRQs', color='red',edgecolors='none', 
            alpha=0.5, marker='.')
plt.scatter(np.log10(bcu["Flux1000"]),bcu["PL_Index"],          #int flux vs. latitude
            label='BCUs', color='orange',edgecolors='none', 
            alpha=0.35, marker='.')
